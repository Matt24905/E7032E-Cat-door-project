...
def normalize_measurements(measurements, target_length=256):
    step_size = len(measurements) / target_length
    return [measurements[int(i * step_size)] for i in range(target_length)]
...
def main():
    ...
    while True:
        ...
        # Normalize the measurements to an array of 256 values
        normalized_measurements = normalize_measurements(raw_measurements)

        #print("normalized_measurements",normalized_measurements)
